...
<html>
  ...
  <body style="text-align: center;">
  	...
  	<h1>用户信息列表</h1>
  	<hr/>
  	<form action="${pageContext.request.contextPath}/servlet/DelMormCustomerServlet" method="post" id="f1">
  		...
  		<tr>
    		...
    		<c:if test="${!empty customerList}">
    			<table width="100%" border="1">
    				...
    				<c:forEach items="${customerList}" var="c" varStatus="vs">
    					<tr bgcolor="${vs.index%2==0?'#CF815E':'#9DE0E0'}">
	    					...
	    					<td>${c.description}</td>
	    					<td>
	    						<a href="${pageContext.request.contextPath}/servlet/UpdateCustomerServletUI?customerId=${c.id}">修改</a>&nbsp;&nbsp;
    ...
    <script type="text/javascript">
    	function delOne(customerId){
        	...
        	if(sure){
            	window.location.href="${pageContext.request.contextPath}/servlet/DelOneCustomerServlet?customerId="+customerId;
            }
        }
        function delMorm(){
            //它是一个数组
